...
export const marketIndexes: MarketIndexSnapshot[] = [
  {
    code: "SPX",
    nameKey: "index.sp500.name",
    region: "US",
    value: 5234.18,
    change: 38.44,
    changePercent: 0.74,
    sessionLabelKey: "index.session.usRegularUp",
  },
  {
    code: "DJI",
    nameKey: "index.dow.name",
    region: "US",
    value: 39284.61,
    change: -112.35,
    changePercent: -0.29,
    sessionLabelKey: "index.session.usRegularDown",
  },
  {
    code: "IXIC",
    nameKey: "index.nasdaqComposite.name",
    region: "US",
    value: 16342.77,
    change: 124.21,
    changePercent: 0.77,
  ...
  {
    code: "RUT",
    nameKey: "index.russell2000.name",
    region: "US",
    value: 2087.35,
    change: 11.42,
    changePercent: 0.55,
...
export const marketPulse: MarketPulse = {
  ...
  decliners: 9,
  turnover: "$328.4B",
  riskMoodKey: "market.riskBalanced",
  hotThemeKey: "market.hotThemeCompute",
};

export const recentSymbols = ["NVDA", "MSFT", "AAPL"];
